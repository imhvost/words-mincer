      ...
      <div class="user-body">
        ...
        <div
          ...
          <div class="settings">
            ...
            <div class="setting">
              <div class="setting-title">{{ text.settings.vibrate.title[lang] }}</div>
              <ul class="setting-radios">
                <li>
                  <label
                    :class="settings.vibrate === 'on' ? 'active' : ''"
                    class="setting-radio-label">
                    <input
                      :checked="settings.vibrate === 'on' ? true : false"
                      type="radio"
                      name="vibrate"
                      value="on"
                      @click="$root.playAudio('click')"
                      @change="changeSettings($event, 'vibrate')">
                    <svg class="icon">
                      <use xlink:href="#vibrate"/>
                    </svg>
                    <span>{{ text.settings.vibrate.values[0][lang] }}</span>
                  </label>
                </li>
                <li>
                  <label
                    :class="settings.vibrate === 'off' ? 'active' : ''"
                    class="setting-radio-label setting-radio-label-off">
                    <input
                      :checked="settings.vibrate === 'off' ? true : false"
                      type="radio"
                      name="vibrate"
                      value="off"
                      @click="$root.playAudio('click')"
                    ...
                    <span>{{ text.settings.vibrate.values[1][lang] }}</span>
                  </label>
                </li>
              </ul>
            </div>
            ...
            <div class="setting setting-full">
              <div class="setting-title">{{ text.settings.cash[lang] }}</div>
              <button
                class="reset-btn"
                @click="resetCash()">
                <svg class="icon">
                ...
                <span>{{ text.settings.cash[lang] }}</span>
              </button>
            </div>
            <div
