    ...
    <div class="container">
      ...
      <div
        ...
        <router-link
          ...
          <svg class="icon profile-cabinet-icon">
...
export default {
  ...
  methods: {
    ...
    signOut () {
      ...
      this.$store.commit('RESET_USER_STATE')
      let promises = [this.$store.dispatch('UPDATE_USER_DATA', firebaseData), this.$store.dispatch('UPDATE_USER_AWARDS', firebaseDataAwards)]
