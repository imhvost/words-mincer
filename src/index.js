...
new Vue({
  ...
  data: {
    audio: {
      ...
      draw: '/static/audio/draw.mp3',
      bomb: '/static/audio/bomb.mp3',
      buy: '/static/audio/buy.mp3',
      correct: '/static/audio/correct.mp3',
      endLevel: '/static/audio/endLevel.mp3',
      endLevelHaveTime: '/static/audio/endLevelHaveTime.mp3',
      endTime: '/static/audio/endTime.mp3',
      error: '/static/audio/error.mp3',
      levelUp: '/static/audio/levelUp.mp3',
      openFirstLetters: '/static/audio/openFirstLetters.mp3',
      openLastLetters: '/static/audio/openLastLetters.mp3',
      skipLevel: '/static/audio/skipLevel.mp3',
      strike: '/static/audio/strike.mp3',
      treasure: '/static/audio/treasure.mp3',
      award: '/static/audio/award.mp3',
      openNothing: '/static/audio/openNothing.mp3',
      endGame: '/static/audio/endGame.mp3'
    },
  ...
  methods: {
    ...
    playAudio (src) {
      ...
      this.audioPlayer.src = this.audio[src]
